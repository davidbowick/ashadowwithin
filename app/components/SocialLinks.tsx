  ...
  return (
    <ul className={styles.socialLinks}>
      <li>
        ...
        >
          {/* YouTube Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 14" className="icon">
      ...
      <li>
        ...
        >
          {/* TikTok Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 18" className="icon">
